...
const TopDoctors = () => {
      ...
      return (
            <div className='flex flex-col items-center gap-4 my-16 text-gray-900 sm:mx-10'>
                  <h1 className='text-3xl font-medium'>Mjekët më të mirë për të rezervuar!</h1>
                  <p className='sm:w-1/3 text-center text-sm'>Thjesht shfleto listën tonë të gjerë të mjekëve të besueshëm.</p>
