...
import { AppContext } from '../../context/AppContext'//'../../context/AppContext'
...
useEffect(() => {
 ...
 return (
    <div className='w-full max-w-6xl m-5'>
      <p className='mb-3 text-lg font-medium'>Te gjitha terminet</p>
      ...
      {appointments.map((item,index)=>(
        ...
        {
        item.cancelled 
        ? <p className='text-red-400 text-xs font-medium'>Anuluar</p>
